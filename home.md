...
**[Translation Skill](https://github.com/irsali/translation-skill)** brings the same translation sync capabilities to any AI coding tool — no extension required.

Works with **Claude Code**, **Cursor**, **GitHub Copilot Chat**, **Windsurf**, **Cline**, **Aider**, and any AI assistant that supports custom instructions.
