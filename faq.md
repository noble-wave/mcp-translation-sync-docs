...
The extension itself requires VS Code. However, if you use a different editor or AI coding tool, check out **[Translation Skill](https://github.com/irsali/translation-skill)** — the same translation sync capabilities as portable markdown-based skill files. Works with Claude Code, Cursor, GitHub Copilot, Windsurf, Cline, Aider, and any AI assistant that supports custom instructions.
...
- Using **[Translation Skill](https://github.com/irsali/translation-skill)** with CLI-based AI tools (Claude Code, Aider) for headless/CI workflows
